...
/**
 * Created by binlin on 2018/8/25.
 */
...
public class CategoryManageController {
    ...
    @ResponseBody
    public ServerResponse addCateogry(HttpServletRequest httpServletRequest, String categoryName, @RequestParam(value = "parentId", defaultValue = "0") int parentId) {
...
//        }
    ...
    @ResponseBody
    public ServerResponse setCateogryName(HttpServletRequest httpServletRequest, Integer categoryId, String categoryName) {
        String loginToken = CookieUtil.readLoginToken(httpServletRequest);
        if (StringUtils.isEmpty(loginToken)) {
            return ServerResponse.createByErrorMessage("用户未登陆，无法获取用户的信息");
        }
